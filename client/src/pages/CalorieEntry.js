...
// Setting username to be Kyoko in cookies
localStorage.setItem("username", "Kyoko");
                                    ...
                                    <Col size="col-md-10">
                                        ...
                                        <select className="chosen-select dropDownMenu1" id="calorieEntryPage-mealNameCaloriesPerSingleQuantity">
                                            ...
                                            */}
                                            ...
                                            <option value="Donut - glazed (269 Cal)">Donut - glazed (269 Cal)</option>
                                            <option value="Donut - plain (253 Cal)">Donut - plain (253 Cal)</option>
                                    ...
                                    <Col size="col-md-10">
                                        ...
                                        <select className="chosen-select dropDownMenu1" id="calorieEntryPage-ingredientNameCaloriesPerGram">
                                            ...
                                            */}
                                            ...
                                            <option value="Kabocha (0.2 Cal/g)">Kabocha (0.2 Cal/g)</option>
                                            ...
                                            <option value="Mushroom (0.3 Cal/g)">Mushroom (0.3 Cal/g)</option>
                                            <option value="Mushroom - enoki (0.3 Cal/g)">Mushroom - enoki (0.3 Cal/g)</option>
                                            <option value="Mushroom - shtake (0.3 Cal/g)">Mushroom - shtake (0.3 Cal/g)</option>
                                            <option value="Mustard (0.6 Cal/g)">Mustard (0.6 Cal/g)</option>
                                            <option value="Noodles - egg (3.9 Cal/g)">Noodles - egg (3.9 Cal/g)</option>
                                            <option value="Noodles - ramen (1.6 Cal/g)">Noodles - ramen (1.6 Cal/g)</option>
                                            <option value="Noodles - rice (1.1 Cal/g)">Noodles - rice (1.1 Cal/g)</option>
                                            <option value="Noodles - soba (1.6 Cal/g)">Noodles - soba (1.6 Cal/g)</option>
                                            <option value="Noodles - somen (3.6 Cal/g)">Noodles - somen (3.6 Cal/g)</option>
                                            <option value="Noodles - udon (1.6 Cal/g)">Noodles - udon (1.6 Cal/g)</option>
                                            ...
                                            <option value="Pecan (6.7 Cal/g)">Pecan (6.7 Cal/g)</option>
                                            ...
                                            <option value="Plantain (1.2 Cal/g)">Plantain (1.2 Cal/g)</option>
                                            ...
                                            <option value="Squash (0.2 Cal/g)">Squash (0.2 Cal/g)</option>
